                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="save-announcement" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label for="iduser">Kursus Penerima </label>
                                                <select class="default-select form-control wide" title="penerima"
                                                    name="penerima" required>
                                                    <option value="-">Pilih Kursus</option>
                                                    <option value="TIDAK ADA">Tidak Ada</option>
                                                    @foreach ($viewkursus as $z)
                                                        <option value="{{ $z->id_kursus }}">{{ $z->nama_kursus }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-xl-6">
                                                        <label for="iduser">Nilai Rata Rata</label>
                                                        <input type="number" class="form-control"
                                                            placeholder="Masukkan Nilai Rata Rata" name="interview" required>
                                                    </div>
                                                    <div class="col-xl-6">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($viewData as $x)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($x->pendaftaran)
                                                    <a href="detail-registration/{{ $x->pendaftaran->id_pendaftaran }}">{{ $x->pendaftaran->id_pendaftaran }}</a>
                                                @else
                                                    -
                                                @endif
                                            </td>
                                            <td>
                                                @if ($x->pendaftaran)
                                                    <a href="detail-registration/{{ $x->pendaftaran->id_pendaftaran }}">{{ $x->pendaftaran->nama_siswa }}</a>
                                                @else
                                                    -
                                                @endif
                                            </td>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <a class="btn btn-secondary shadow btn-xs sharp me-1"
                                                            ...
                                                            href="view-announcement/{{ $x->pendaftaran ? $x->pendaftaran->id_pendaftaran : '#' }}"><i
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="update-announcement/{{ $x->id_pengumuman }}"
                                                                    ...
                                                                    <div class="col-xl-6">
                                                                        ...
                                                                        <select class="default-select form-control wide"
                                                                            ...
                                                                            <option value="{{ $x->id_pendaftaran }}">
                                                                                {{ $x->pendaftaran ? $x->pendaftaran->id_pendaftaran : '-' }}</option>
                                                                        </select>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="iduser">Kursus Penerima </label>
                                                                <select class="default-select form-control wide"
                                                                    title="Recipient" name="kursus" required>
                                                                    @if ($x->hasil_seleksi == "LULUS" || $x->hasil_seleksi == "Lulus" || $x->hasil_seleksi == "lulus")
                                                                    <option value="{{ $x->kursus_penerima }}" selected>{{ $x->kursus->nama_kursus }}</option>
                                                                    @endif
                                                                    <option value="{{ $x->pendaftaran ? $x->pendaftaran->pil1 : '-' }}">Pilihan 1 : {{ $x->pendaftaran ? $x->pendaftaran->pilihan1->nama_kursus : '-' }}</option>
            ...
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col-sm-8">
                        ...
                        <h5 class="card-title">Pengumuman Seleksi Penerimaan peserta kursus baru </h5> <br>
